...
class GameManagementApp:
    ...
    def create_settings_tab(self):
        ...
        widget2.grid_rowconfigure(1, weight=0, minsize=48)  # Button row 1
        widget2.grid_rowconfigure(2, weight=0, minsize=48)  # Button row 2
